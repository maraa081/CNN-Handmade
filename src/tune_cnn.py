...
print(f"  OK Images : {x_train.shape[0]} train / {x_test.shape[0]} test")
print(f"  OK Format : {next(iter(train_loader))[0].shape}")
print(f"  OK ~{n_batches} batches par epoch")
...
print(f"\n[time]  Temps d'entraînement : {int(m)}m {int(s)}s")
