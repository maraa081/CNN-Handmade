...
--------------------------------------------------------------------------
  ...
  Ce modèle cumule TOUT ce qu'on a implémenté :
    ...
    OK Adam          — lr adaptatif + momentum
    OK Dropout       — régularisation par désactivation aléatoire
    OK L2 Weight Decay — pénalise les gros poids
