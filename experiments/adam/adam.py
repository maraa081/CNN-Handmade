...
--------------------------------------------------------------------------
  ...
  Théorie :
      ...
      θ <- θ - lr · m / (√v + ε)    (mise à jour normalisée)
  ...
  Lancement : python3 experiments/adam/adam.py
  Résultat   : experiments/adam/adam.png
--------------------------------------------------------------------------
"""
...
plt.tight_layout()
out = join(dirname(abspath(__file__)), "adam.png")
plt.savefig(out, dpi=150, bbox_inches="tight")
print(f"\n Graphique : {out}")

# -- Sauvegarde des poids --
weights_path = join(dirname(abspath(__file__)), "adam_weights.npz")
